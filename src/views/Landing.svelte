  ...
  <main>
          ...
          <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
            <div class="pr-12">
              ...
              <p class="mt-4 text-lg text-gray-300">
                TechTouch built upon the idea of CSR (Corporate Social Responsibility), we have been struggling with hiring competent software developers. Thus, we decided to jump in and act instead of just whining!
                <br/>
                We have been building software for over 10 years and contributing to the job market for over 2 years.
    ...
    <section class="pb-20 bg-gray-300 -mt-24">
      <div class="container mx-auto px-4">
          ...
          <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                <h6 class="text-xl font-semibold">Award Wining Training</h6>
                <p class="mt-2 mb-4 text-gray-600">
                  We are the exclusive Harvard CS50 partner licensed to teach CS50x In Iraq. Over 50 success stories in our belt.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                <h6 class="text-xl font-semibold">World-class Energized Projects</h6>
                <p class="mt-2 mb-4 text-gray-600">
                  You cannot be more comfortable by building your software solutions with us. We provide world-class solutions with continuous support and constant maintenance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="pt-6 w-full md:w-4/12 px-4 text-center">
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mt-2 mb-4 text-gray-600">
                  We are a legally registered company, we live at the Station, come find us or give us a call and we will be right there.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap items-center mt-32 ml-auto">
          ...
          <div class="mt-4 w-full md:w-4/12 px-4 mr-auto">
            <div
